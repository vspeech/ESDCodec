...
def prepare_gluster_dataset(data_type, data_list_file, data_pipeline: list, shuffle=True, partition=True, mode="train"):
    """
    Args:
        data_list (DataList):
        data_pipeline (list):
    ...
    lists = read_lists(data_list_file)
    data_list = DataList(lists, shuffle=shuffle, partition=partition)
    for func in data_pipeline:
