...
from esdcodec.utils.utils_infer import (
    tqdm,
    device,
    cross_fade_duration,
    torch,
...
from esdcodec.utils import normalize_text
...
from esdcodec.utils.utils_infer import instantiate_model, load_checkpoint


# load models
def load_esdcodec_valle_ar_25hzv1():
    TTS_MODEL_CFG = {
        "model": "valle_ar",
        "ckpt_path": "esdcodec_tts_ckpts/esdcodec_valle_ar_25hzv1.safetensors",
...
def load_esdcodec_valle_nar_25hzv1():
    TTS_MODEL_CFG = {
        "model": "valle_nar",
        "ckpt_path": "esdcodec_tts_ckpts/esdcodec_valle_nar_25hzv1.safetensors",
...
def infer_process(
    ...
    return next(
        infer_batch_process(
            ...
            ar_model_obj,
            nar_model_obj,
            esdcodec_inference_obj=esdcodec_inference_obj,
...
def valle_ar_inference(
    ...
    prompt_semantic_code, prompt_acoustic_code = esdcodec_inference_obj.encode(
...
def valle_nar_inference(
    ...
    combine_audio = esdcodec_inference_obj.decode(
        predict_full[:, :1],
        predict_full[:, 1:],
    )
