...
from esdcodec.infer.valle.utils_valle_infer import (
    infer_process,
    load_esdcodec_valle_nar_25hzv1,
    load_esdcodec_valle_ar_25hzv1,
)
...
ar_model = load_esdcodec_valle_ar_25hzv1()
nar_model = load_esdcodec_valle_nar_25hzv1()
from esdcodec.utils import get_whisper_tokenizer

tokenizer_model = get_whisper_tokenizer()
import esdcodec

esdcodec_model = esdcodec.get_model("25hz_v1")
esdcodec_inference_obj = esdcodec.Inference(
    esdcodec_model=esdcodec_model, device=device, autocast=True
)
